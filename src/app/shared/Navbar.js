        ...
        <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul className="navbar-nav navbar-nav-right">
            ...
            <li className="nav-item d-none d-lg-block">
              <a className="nav-link btn btn-danger" href="!#" onClick={event => event.preventDefault()}>
                <i className="mdi mdi-view-grid"></i> Report Fraud
              </a>
            </li>
            <Dropdown alignRight as="li" className="nav-item border-left" >
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list">
                ...
                <Dropdown.Item href="!#" onClick={evt => evt.preventDefault()} className="preview-item">
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject ellipsis mb-1"><Trans>Order Shipped</Trans></p>
                ...
                <Dropdown.Item href="!#" onClick={evt => evt.preventDefault()} className="preview-item">
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject ellipsis mb-1"><Trans>Order Delivered</Trans></p>
                ...
                <Dropdown.Item href="!#" onClick={evt => evt.preventDefault()} className="preview-item">
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject ellipsis mb-1"><Trans>New Product Request</Trans></p>
            ...
            <Dropdown alignRight as="li" className="nav-item border-left">
              ...
              <Dropdown.Menu className="dropdown-menu navbar-dropdown preview-list">
                ...
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt => evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject mb-1"><Trans>New Order</Trans></p>
                    <p className="text-muted ellipsis mb-0">
                      <Trans>You have a new order to process</Trans>
                    </p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt => evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    <h6 className="preview-subject mb-1"><Trans>Order Dispatched</Trans></h6>
                    <p className="text-muted ellipsis mb-0">
                      <Trans>Your order has been dispatched </Trans>
                    </p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
                <Dropdown.Item className="dropdown-item preview-item" onClick={evt => evt.preventDefault()}>
                  ...
                  <div className="preview-item-content">
                    <h6 className="preview-subject mb-1"><Trans>Payment Received</Trans></h6>
                    <p className="text-muted ellipsis mb-0">
                      <Trans>You have a payment in your wallet</Trans>!
                    </p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
            ...
            <Dropdown alignRight as="li" className="nav-item">
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                <div className="navbar-profile">
                  ...
                  <p className="mb-0 d-none d-sm-block navbar-profile-name"><Trans>Chinedu Ukpe</Trans></p>
